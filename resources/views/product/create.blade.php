...
<body>
    <div class="sus_icon content d-flex justify-content-center align-items-center">
        <i class="bi bi-person-bounding-box" style="color: #272727"></i>
        <span>{{ Auth::user()->username }} (admin)</span> 
        <a href={{ route('logout') }}><i class="bi bi-box-arrow-left" style="color: #737373"></i> </a> 
        <a href="{{ route('products.index') }}"><i class="bi bi-eye" style="color: #148312;"></i></a>
    </div>
    <div class="continut">
        <div class="cont_log">
    ...
    <div class="elem_create">
        <h3>Price</h3>
        <input type="text" name="price" pattern="[0-9]+([,\.][0-9]+)?" placeholder="Enter product price" step="any" oninput="this.value = this.value.replace(/[^0-9\.,]/g, '')">
